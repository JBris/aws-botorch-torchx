...
def parse_args():
    ...
    parser.add_argument(
        "--hidden_size_1", type=int, required=False, 
        help="hidden size layer 1", default=16
    )
    parser.add_argument(
        "--hidden_size_2", type=int, required=False, 
        help="hidden size layer 2", default=16
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--dropout", type=float, required=False, 
